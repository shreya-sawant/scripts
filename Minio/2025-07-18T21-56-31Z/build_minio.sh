...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/minio/2025-05-24T17-08-30Z/build_minio.sh
# Execute build script: bash build_minio.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="minio"
PACKAGE_VERSION="RELEASE.2025-07-18T21-56-31Z"
MC_PACKAGE_VERSION="RELEASE.2025-07-16T15-35-03Z"
CURDIR="$(pwd)"
SOURCE_ROOT="$(pwd)"
FORCE="false"
